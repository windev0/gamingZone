                            ...
                            <div class="card card-plain">
                                ...
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="flex flex-col mb-3">
                                            <input type="email" name="email" class="form-control form-control-lg" value="{{ old('email') }}" aria-label="Email" placeholder="votremail@gmail.com">
                                            @error('email') <p class="text-danger text-xs pt-1"> {{$message}} </p>@enderror
                                        </div>
                                        <div class="flex flex-col mb-3">
                                            <input type="password" name="password" class="form-control form-control-lg" aria-label="Password" placeholder="votre mot de passe">
                                ...
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    <p class="mb-1 text-sm mx-auto">
                                        ...
                                        <a href="{{route('password.request')}}" class="text-primary text-gradient font-weight-bold">ici </a>pour réinitialiser
                                    </p>
                                </div>
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">

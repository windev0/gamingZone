...
@section('product-actions')
    ...
    <div class="card " style="margin-top: 13%; margin-left:15%;">
        ...
        <div class="card-body">
            <form action="{{ url('/admin/update-phone/' . $phone->id) }}" method="POST"
                ...
                <div>
                    ...
                    <div class="mt-3 mb-3 img">
                        <img src="{{asset('/assets/products/images/phone/'.$phone->image.'')}}" alt="" width="600"
                            height="350">
                    </div>
                    <div class="form-group form-line">

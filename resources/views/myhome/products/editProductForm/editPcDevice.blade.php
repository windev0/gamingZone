...
@section('product-actions')
    ...
    <div class="card " style="margin-top: 13%; margin-left:15%;">
        ...
        <div class="card-body">
            <form action="{{ url('/admin/update-pc-device/' . $pc_device->id) }}" method="POST"
                ...
                <div>
                    ...
                    <div class="mt-3 mb-3 img">
                        <img src="{{asset('/assets/products/images/pc/'.$pc_device->image.'')}}" alt="" width="600"
                            height="350">
                    </div>
                    <div class="form-group form-line">
